...
2. Deploy via Helm
Install the chart located in ./diagnostic-operator. Note: You must specify a valid StorageClass for your cluster (e.g., managed-nfs-storage, ocs-storagecluster-cephfs, or standard).
